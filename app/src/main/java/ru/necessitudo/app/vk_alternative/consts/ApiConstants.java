package ru.necessitudo.app.vk_alternative.consts;
...
public class ApiConstants {
    public static final String[] DEFAULT_LOGIN_SCOPE = {VKScope.EMAIL, VKScope.AUDIO, VKScope.DIRECT, VKScope.VIDEO,
            VKScope.WALL, VKScope.MESSAGES, VKScope.PHOTOS, VKScope.GROUPS, VKScope.PAGES,
    ...
    public static final int MY_GROUP_ID = -86333561;
